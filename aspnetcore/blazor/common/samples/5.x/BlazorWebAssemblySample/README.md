# <a name="blazor-webassembly-sample-app"></a><span data-ttu-id="b19f9-101">Blazor WebAssembly 샘플 앱</span><span class="sxs-lookup"><span data-stu-id="b19f9-101">Blazor WebAssembly Sample App</span></span>
