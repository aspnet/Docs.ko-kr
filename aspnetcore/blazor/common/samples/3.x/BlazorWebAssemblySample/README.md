# <a name="blazor-webassembly-sample-app"></a><span data-ttu-id="a4b17-101">Blazor WebAssembly 샘플 앱</span><span class="sxs-lookup"><span data-stu-id="a4b17-101">Blazor WebAssembly Sample App</span></span>
