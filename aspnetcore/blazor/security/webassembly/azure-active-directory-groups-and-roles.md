...
<span data-ttu-id="e3e7d-107">AAD(Azure Active Directory)는 ASP.NET Core Identity와 결합할 수 있는 몇 가지 권한 부여 방법을 제공합니다.</span><span class="sxs-lookup"><span data-stu-id="e3e7d-107">Azure Active Directory (AAD) provides several authorization approaches that can be combined with ASP.NET Core Identity:</span></span>
...
## <a name="user-defined-groups-and-administrator-roles"></a><span data-ttu-id="e3e7d-123">사용자 정의 그룹 및 관리자 역할</span><span class="sxs-lookup"><span data-stu-id="e3e7d-123">User-defined groups and Administrator Roles</span></span>
...
<span data-ttu-id="e3e7d-137">`CustomUserAccount.cs`:</span><span class="sxs-lookup"><span data-stu-id="e3e7d-137">`CustomUserAccount.cs`:</span></span>
...
<span data-ttu-id="e3e7d-166">`CustomAccountFactory.cs`:</span><span class="sxs-lookup"><span data-stu-id="e3e7d-166">`CustomAccountFactory.cs`:</span></span>
...
<span data-ttu-id="e3e7d-180">[`AuthorizeView` 구성 요소](xref:blazor/security/index#authorizeview-component)는 이 정책을 준수합니다.</span><span class="sxs-lookup"><span data-stu-id="e3e7d-180">The [`AuthorizeView` component](xref:blazor/security/index#authorizeview-component) works with the policy:</span></span>
...
* <span data-ttu-id="e3e7d-194">`access_as_user` 범위가 필요하지 않습니다.</span><span class="sxs-lookup"><span data-stu-id="e3e7d-194">Require the the `access_as_user` scope.</span></span>
...
>
> <span data-ttu-id="e3e7d-214">자세한 내용은 <xref:blazor/security/webassembly/hosted-with-azure-active-directory#app-settings>를 참조하세요.</span><span class="sxs-lookup"><span data-stu-id="e3e7d-214">For more information, see <xref:blazor/security/webassembly/hosted-with-azure-active-directory#app-settings>.</span></span>
...
<span data-ttu-id="e3e7d-250"><xref:Microsoft.AspNetCore.Authentication.JwtBearer.JwtBearerEvents>를 구성하는 경우:</span><span class="sxs-lookup"><span data-stu-id="e3e7d-250">When configuring <xref:Microsoft.AspNetCore.Authentication.JwtBearer.JwtBearerEvents>:</span></span>
...
<span data-ttu-id="e3e7d-257">앞의 예제에서:</span><span class="sxs-lookup"><span data-stu-id="e3e7d-257">In the preceding example:</span></span>
...
* <span data-ttu-id="e3e7d-268">다음 코드 줄의 경우</span><span class="sxs-lookup"><span data-stu-id="e3e7d-268">For the code line:</span></span>
...
<span data-ttu-id="e3e7d-276">다음 예제에서는 앱이 두 개의 역할로 구성되어 있다고 가정합니다.</span><span class="sxs-lookup"><span data-stu-id="e3e7d-276">The following example assumes that an app is configured with two roles:</span></span>
...
<span data-ttu-id="e3e7d-314">B2C 사용자 흐름 특성 관리자</span><span class="sxs-lookup"><span data-stu-id="e3e7d-314">B2C user flow attribute administrator</span></span> | <span data-ttu-id="e3e7d-315">dd0baca0-a535-48c1-b871-8431abe16452</span><span class="sxs-lookup"><span data-stu-id="e3e7d-315">dd0baca0-a535-48c1-b871-8431abe16452</span></span>
<span data-ttu-id="e3e7d-316">대금 청구 관리자</span><span class="sxs-lookup"><span data-stu-id="e3e7d-316">Billing administrator</span></span> | <span data-ttu-id="e3e7d-317">69ff516a-b57d-4697-a429-9de4af7b5609</span><span class="sxs-lookup"><span data-stu-id="e3e7d-317">69ff516a-b57d-4697-a429-9de4af7b5609</span></span>
<span data-ttu-id="e3e7d-318">클라우드 애플리케이션 관리자</span><span class="sxs-lookup"><span data-stu-id="e3e7d-318">Cloud application administrator</span></span> | <span data-ttu-id="e3e7d-319">250b5fe3-b553-458d-9a53-b782c13c34bf</span><span class="sxs-lookup"><span data-stu-id="e3e7d-319">250b5fe3-b553-458d-9a53-b782c13c34bf</span></span>
<span data-ttu-id="e3e7d-320">클라우드 디바이스 관리자</span><span class="sxs-lookup"><span data-stu-id="e3e7d-320">Cloud device administrator</span></span> | <span data-ttu-id="e3e7d-321">26cd4b44-2636-4ddb-bdfa-27feae66f86d</span><span class="sxs-lookup"><span data-stu-id="e3e7d-321">26cd4b44-2636-4ddb-bdfa-27feae66f86d</span></span>
<span data-ttu-id="e3e7d-322">규정 준수 관리자</span><span class="sxs-lookup"><span data-stu-id="e3e7d-322">Compliance administrator</span></span> | <span data-ttu-id="e3e7d-323">9d6e1dd0-c9f8-45f8-b558-b134f700116c</span><span class="sxs-lookup"><span data-stu-id="e3e7d-323">9d6e1dd0-c9f8-45f8-b558-b134f700116c</span></span>
<span data-ttu-id="e3e7d-324">규정 준수 데이터 관리자</span><span class="sxs-lookup"><span data-stu-id="e3e7d-324">Compliance data administrator</span></span> | <span data-ttu-id="e3e7d-325">4c0ca3a2-231e-416c-9411-4abe57d5cb9d</span><span class="sxs-lookup"><span data-stu-id="e3e7d-325">4c0ca3a2-231e-416c-9411-4abe57d5cb9d</span></span>
<span data-ttu-id="e3e7d-326">조건부 액세스 관리자</span><span class="sxs-lookup"><span data-stu-id="e3e7d-326">Conditional Access administrator</span></span> | <span data-ttu-id="e3e7d-327">8f71a611-137d-49af-87ad-e97f1fd5da76</span><span class="sxs-lookup"><span data-stu-id="e3e7d-327">8f71a611-137d-49af-87ad-e97f1fd5da76</span></span>
<span data-ttu-id="e3e7d-328">고객 LockBox 액세스 승인자</span><span class="sxs-lookup"><span data-stu-id="e3e7d-328">Customer LockBox access approver</span></span> | <span data-ttu-id="e3e7d-329">c18d54a8-b13e-4954-a1a4-7deaf2e4f184</span><span class="sxs-lookup"><span data-stu-id="e3e7d-329">c18d54a8-b13e-4954-a1a4-7deaf2e4f184</span></span>
<span data-ttu-id="e3e7d-330">Desktop Analytics 관리자</span><span class="sxs-lookup"><span data-stu-id="e3e7d-330">Desktop Analytics administrator</span></span> | <span data-ttu-id="e3e7d-331">c62c4ac5-e4c6-4096-8a2f-1ee3cbaaae15</span><span class="sxs-lookup"><span data-stu-id="e3e7d-331">c62c4ac5-e4c6-4096-8a2f-1ee3cbaaae15</span></span>
<span data-ttu-id="e3e7d-332">디렉터리 읽기 권한자</span><span class="sxs-lookup"><span data-stu-id="e3e7d-332">Directory readers</span></span> | <span data-ttu-id="e3e7d-333">e1fc84a6-7762-4b9b-8e29-518b4adbc23b</span><span class="sxs-lookup"><span data-stu-id="e3e7d-333">e1fc84a6-7762-4b9b-8e29-518b4adbc23b</span></span>
<span data-ttu-id="e3e7d-334">Dynamics 365 관리자</span><span class="sxs-lookup"><span data-stu-id="e3e7d-334">Dynamics 365 administrator</span></span> | <span data-ttu-id="e3e7d-335">f20a9cfa-9fdf-49a8-a977-1afe446a1d6e</span><span class="sxs-lookup"><span data-stu-id="e3e7d-335">f20a9cfa-9fdf-49a8-a977-1afe446a1d6e</span></span>
<span data-ttu-id="e3e7d-336">Exchange 관리자</span><span class="sxs-lookup"><span data-stu-id="e3e7d-336">Exchange administrator</span></span> | <span data-ttu-id="e3e7d-337">b2ec2cc0-d5c9-4864-ad9b-38dd9dba2652</span><span class="sxs-lookup"><span data-stu-id="e3e7d-337">b2ec2cc0-d5c9-4864-ad9b-38dd9dba2652</span></span>
<span data-ttu-id="e3e7d-338">외부 Identity 공급자 관리자</span><span class="sxs-lookup"><span data-stu-id="e3e7d-338">External Identity Provider administrator</span></span> | <span data-ttu-id="e3e7d-339">febfaeb4-e478-407a-b4b3-f4d9716618a2</span><span class="sxs-lookup"><span data-stu-id="e3e7d-339">febfaeb4-e478-407a-b4b3-f4d9716618a2</span></span>
<span data-ttu-id="e3e7d-340">전역 관리자</span><span class="sxs-lookup"><span data-stu-id="e3e7d-340">Global administrator</span></span> | <span data-ttu-id="e3e7d-341">a45ba61b-44db-462c-924b-3b2719152588</span><span class="sxs-lookup"><span data-stu-id="e3e7d-341">a45ba61b-44db-462c-924b-3b2719152588</span></span>
<span data-ttu-id="e3e7d-342">글로벌 읽기 권한자</span><span class="sxs-lookup"><span data-stu-id="e3e7d-342">Global reader</span></span> | <span data-ttu-id="e3e7d-343">f6903b21-6aba-4124-b44c-76671796b9d5</span><span class="sxs-lookup"><span data-stu-id="e3e7d-343">f6903b21-6aba-4124-b44c-76671796b9d5</span></span>
<span data-ttu-id="e3e7d-344">그룹 관리자</span><span class="sxs-lookup"><span data-stu-id="e3e7d-344">Groups administrator</span></span> | <span data-ttu-id="e3e7d-345">158b3e5a-d89d-460b-92b5-3b34985f0197</span><span class="sxs-lookup"><span data-stu-id="e3e7d-345">158b3e5a-d89d-460b-92b5-3b34985f0197</span></span>
<span data-ttu-id="e3e7d-346">게스트 초대자</span><span class="sxs-lookup"><span data-stu-id="e3e7d-346">Guest inviter</span></span> | <span data-ttu-id="e3e7d-347">4c730a1d-cc22-44af-8f9f-4eec635c7502</span><span class="sxs-lookup"><span data-stu-id="e3e7d-347">4c730a1d-cc22-44af-8f9f-4eec635c7502</span></span>
<span data-ttu-id="e3e7d-348">기술 지원팀 관리자</span><span class="sxs-lookup"><span data-stu-id="e3e7d-348">Helpdesk administrator</span></span> | <span data-ttu-id="e3e7d-349">108678c8-6628-44e1-8d01-caf598a6a5f5</span><span class="sxs-lookup"><span data-stu-id="e3e7d-349">108678c8-6628-44e1-8d01-caf598a6a5f5</span></span>
<span data-ttu-id="e3e7d-350">Intune 관리자</span><span class="sxs-lookup"><span data-stu-id="e3e7d-350">Intune administrator</span></span> | <span data-ttu-id="e3e7d-351">79950741-23fa-4189-b2cb-46640601c497</span><span class="sxs-lookup"><span data-stu-id="e3e7d-351">79950741-23fa-4189-b2cb-46640601c497</span></span>
<span data-ttu-id="e3e7d-352">Kaizala 관리자</span><span class="sxs-lookup"><span data-stu-id="e3e7d-352">Kaizala administrator</span></span> | <span data-ttu-id="e3e7d-353">d6322af2-48e7-42e0-8c68-0bbe31af3412</span><span class="sxs-lookup"><span data-stu-id="e3e7d-353">d6322af2-48e7-42e0-8c68-0bbe31af3412</span></span>
<span data-ttu-id="e3e7d-354">라이선스 관리자</span><span class="sxs-lookup"><span data-stu-id="e3e7d-354">License administrator</span></span> | <span data-ttu-id="e3e7d-355">3355458a-e423-44bf-8b98-4ac5e572cea5</span><span class="sxs-lookup"><span data-stu-id="e3e7d-355">3355458a-e423-44bf-8b98-4ac5e572cea5</span></span>
<span data-ttu-id="e3e7d-356">메시지 센터 개인 정보 읽기 권한자</span><span class="sxs-lookup"><span data-stu-id="e3e7d-356">Message center privacy reader</span></span> | <span data-ttu-id="e3e7d-357">6395db95-9fb8-42b9-b1ed-30a2405eee6f</span><span class="sxs-lookup"><span data-stu-id="e3e7d-357">6395db95-9fb8-42b9-b1ed-30a2405eee6f</span></span>
<span data-ttu-id="e3e7d-358">메시지 센터 읽기 권한자</span><span class="sxs-lookup"><span data-stu-id="e3e7d-358">Message center reader</span></span> | <span data-ttu-id="e3e7d-359">fd5d37b8-4e24-434b-9e63-70ed3b759a16</span><span class="sxs-lookup"><span data-stu-id="e3e7d-359">fd5d37b8-4e24-434b-9e63-70ed3b759a16</span></span>
<span data-ttu-id="e3e7d-360">Office 앱 관리자</span><span class="sxs-lookup"><span data-stu-id="e3e7d-360">Office apps administrator</span></span> | <span data-ttu-id="e3e7d-361">5f3870cd-b042-4f93-86d7-c9d77c664dc7</span><span class="sxs-lookup"><span data-stu-id="e3e7d-361">5f3870cd-b042-4f93-86d7-c9d77c664dc7</span></span>
<span data-ttu-id="e3e7d-362">암호 관리자</span><span class="sxs-lookup"><span data-stu-id="e3e7d-362">Password administrator</span></span> | <span data-ttu-id="e3e7d-363">466e48b7-5d66-4ae5-8911-1a118de74941</span><span class="sxs-lookup"><span data-stu-id="e3e7d-363">466e48b7-5d66-4ae5-8911-1a118de74941</span></span>
<span data-ttu-id="e3e7d-364">Power BI 관리자</span><span class="sxs-lookup"><span data-stu-id="e3e7d-364">Power BI administrator</span></span> | <span data-ttu-id="e3e7d-365">984e83b8-8337-4255-91a1-acb663175ab4</span><span class="sxs-lookup"><span data-stu-id="e3e7d-365">984e83b8-8337-4255-91a1-acb663175ab4</span></span>
<span data-ttu-id="e3e7d-366">Power Platform 관리자</span><span class="sxs-lookup"><span data-stu-id="e3e7d-366">Power platform administrator</span></span> | <span data-ttu-id="e3e7d-367">76d6f95e-9a15-4d7d-8d21-00de00faf9fd</span><span class="sxs-lookup"><span data-stu-id="e3e7d-367">76d6f95e-9a15-4d7d-8d21-00de00faf9fd</span></span>
<span data-ttu-id="e3e7d-368">권한 있는 인증 관리자</span><span class="sxs-lookup"><span data-stu-id="e3e7d-368">Privileged authentication administrator</span></span> | <span data-ttu-id="e3e7d-369">0829f731-b46d-419f-9742-aeb122367d11</span><span class="sxs-lookup"><span data-stu-id="e3e7d-369">0829f731-b46d-419f-9742-aeb122367d11</span></span>
<span data-ttu-id="e3e7d-370">권한 있는 역할 관리자</span><span class="sxs-lookup"><span data-stu-id="e3e7d-370">Privileged role administrator</span></span> | <span data-ttu-id="e3e7d-371">f20a725a-d1c8-4107-83ea-1171c97d00c7</span><span class="sxs-lookup"><span data-stu-id="e3e7d-371">f20a725a-d1c8-4107-83ea-1171c97d00c7</span></span>
<span data-ttu-id="e3e7d-372">보고서 읽기 권한자</span><span class="sxs-lookup"><span data-stu-id="e3e7d-372">Reports reader</span></span> | <span data-ttu-id="e3e7d-373">54635450-e8ed-4f2d-9632-07db2517b4de</span><span class="sxs-lookup"><span data-stu-id="e3e7d-373">54635450-e8ed-4f2d-9632-07db2517b4de</span></span>
<span data-ttu-id="e3e7d-374">Search 관리자</span><span class="sxs-lookup"><span data-stu-id="e3e7d-374">Search administrator</span></span> | <span data-ttu-id="e3e7d-375">c770a2f1-c9ba-4e60-9176-9f52b1eb1a31</span><span class="sxs-lookup"><span data-stu-id="e3e7d-375">c770a2f1-c9ba-4e60-9176-9f52b1eb1a31</span></span>
<span data-ttu-id="e3e7d-376">Search 편집자</span><span class="sxs-lookup"><span data-stu-id="e3e7d-376">Search editor</span></span> | <span data-ttu-id="e3e7d-377">6a6858c6-5f0d-44ac-87c7-0190fbedd271</span><span class="sxs-lookup"><span data-stu-id="e3e7d-377">6a6858c6-5f0d-44ac-87c7-0190fbedd271</span></span>
<span data-ttu-id="e3e7d-378">보안 관리자</span><span class="sxs-lookup"><span data-stu-id="e3e7d-378">Security administrator</span></span> | <span data-ttu-id="e3e7d-379">20fa50e3-6531-44d8-bd39-b251420568ad</span><span class="sxs-lookup"><span data-stu-id="e3e7d-379">20fa50e3-6531-44d8-bd39-b251420568ad</span></span>
<span data-ttu-id="e3e7d-380">보안 운영자</span><span class="sxs-lookup"><span data-stu-id="e3e7d-380">Security operator</span></span> | <span data-ttu-id="e3e7d-381">43aae017-8e51-4188-91ab-e6debd572800</span><span class="sxs-lookup"><span data-stu-id="e3e7d-381">43aae017-8e51-4188-91ab-e6debd572800</span></span>
<span data-ttu-id="e3e7d-382">보안 판독기</span><span class="sxs-lookup"><span data-stu-id="e3e7d-382">Security reader</span></span> | <span data-ttu-id="e3e7d-383">45035cd3-fd97-4250-8197-3a53d3562d9b</span><span class="sxs-lookup"><span data-stu-id="e3e7d-383">45035cd3-fd97-4250-8197-3a53d3562d9b</span></span>
<span data-ttu-id="e3e7d-384">서비스 지원 관리자</span><span class="sxs-lookup"><span data-stu-id="e3e7d-384">Service support administrator</span></span> | <span data-ttu-id="e3e7d-385">2c92cf45-c914-48f8-9bf9-fc14b28818ab</span><span class="sxs-lookup"><span data-stu-id="e3e7d-385">2c92cf45-c914-48f8-9bf9-fc14b28818ab</span></span>
<span data-ttu-id="e3e7d-386">SharePoint 관리자</span><span class="sxs-lookup"><span data-stu-id="e3e7d-386">SharePoint administrator</span></span> | <span data-ttu-id="e3e7d-387">e1c32229-875e-461d-ae24-3cb99116e86c</span><span class="sxs-lookup"><span data-stu-id="e3e7d-387">e1c32229-875e-461d-ae24-3cb99116e86c</span></span>
<span data-ttu-id="e3e7d-388">비즈니스용 Skype 관리자</span><span class="sxs-lookup"><span data-stu-id="e3e7d-388">Skype for Business administrator</span></span> | <span data-ttu-id="e3e7d-389">0a8cee12-e21d-43ef-abd9-f1ea85710e30</span><span class="sxs-lookup"><span data-stu-id="e3e7d-389">0a8cee12-e21d-43ef-abd9-f1ea85710e30</span></span>
<span data-ttu-id="e3e7d-390">Teams 통신 관리자</span><span class="sxs-lookup"><span data-stu-id="e3e7d-390">Teams Communications Administrator</span></span> | <span data-ttu-id="e3e7d-391">2393e455-6e13-4743-9f52-63fcec2b6a9c</span><span class="sxs-lookup"><span data-stu-id="e3e7d-391">2393e455-6e13-4743-9f52-63fcec2b6a9c</span></span>
<span data-ttu-id="e3e7d-392">Teams 통신 지원 엔지니어</span><span class="sxs-lookup"><span data-stu-id="e3e7d-392">Teams Communications Support Engineer</span></span> | <span data-ttu-id="e3e7d-393">802dd94e-d717-46f6-af98-b9167071e9fc</span><span class="sxs-lookup"><span data-stu-id="e3e7d-393">802dd94e-d717-46f6-af98-b9167071e9fc</span></span>
<span data-ttu-id="e3e7d-394">Teams 커뮤니케이션 전문가</span><span class="sxs-lookup"><span data-stu-id="e3e7d-394">Teams Communications Specialist</span></span> | <span data-ttu-id="e3e7d-395">ef547281-cf46-4cc6-bcaa-f5eac3f030c9</span><span class="sxs-lookup"><span data-stu-id="e3e7d-395">ef547281-cf46-4cc6-bcaa-f5eac3f030c9</span></span>
<span data-ttu-id="e3e7d-396">Teams 서비스 관리자</span><span class="sxs-lookup"><span data-stu-id="e3e7d-396">Teams Service Administrator</span></span> | <span data-ttu-id="e3e7d-397">8846a0be-197b-443a-b13c-11192691fa24</span><span class="sxs-lookup"><span data-stu-id="e3e7d-397">8846a0be-197b-443a-b13c-11192691fa24</span></span>
<span data-ttu-id="e3e7d-398">사용자 관리자</span><span class="sxs-lookup"><span data-stu-id="e3e7d-398">User administrator</span></span> | <span data-ttu-id="e3e7d-399">1f6eed58-7dd3-460b-a298-666f975427a1</span><span class="sxs-lookup"><span data-stu-id="e3e7d-399">1f6eed58-7dd3-460b-a298-666f975427a1</span></span>

## <a name="additional-resources"></a><span data-ttu-id="e3e7d-400">추가 자료</span><span class="sxs-lookup"><span data-stu-id="e3e7d-400">Additional resources</span></span>
