...
앱에서 Docker를 사용 하는 경우 ASP.NET Core 3.0를 포함 하는 기본 이미지를 사용 합니다. 예: `docker pull mcr.microsoft.com/dotnet/core/aspnet:3.0`.
...
SignalRJavaScript 클라이언트가에서로 변경 되었습니다 `@aspnet/signalr` `@microsoft/signalr` . 이 변경 내용에 대응 하려면 파일, *package.json* `require` 문 및 ECMAScript 문에서package.js의 참조를 변경 합니다 `import` .
