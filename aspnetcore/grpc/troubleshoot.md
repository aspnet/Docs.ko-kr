...
1. <span data-ttu-id="ea6f6-171">새 .NET Core 클래스 라이브러리 프로젝트를 만듭니다.</span><span class="sxs-lookup"><span data-stu-id="ea6f6-171">Create a new .NET Core class library project.</span></span>
