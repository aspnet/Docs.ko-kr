...
---
# <a name="part-6-no-locrazor-pages-with-ef-core-in-aspnet-core---read-related-data"></a><span data-ttu-id="feb5f-103">6부. ASP.NET Core에서 EF Core를 사용한 Razor Pages - 관련 데이터 읽기</span><span class="sxs-lookup"><span data-stu-id="feb5f-103">Part 6, Razor Pages with EF Core in ASP.NET Core - Read Related Data</span></span>
...
<span data-ttu-id="feb5f-442">다음 태그를 *Pages/Instructors/Index.cshtml* Razor 페이지 끝에 추가합니다.</span><span class="sxs-lookup"><span data-stu-id="feb5f-442">Add the following markup to the end of the *Pages/Instructors/Index.cshtml* Razor Page:</span></span>
