<span data-ttu-id="28fee-101">`dotnet ef`가 설치되지 않은 경우 전역 도구로 설치합니다.</span><span class="sxs-lookup"><span data-stu-id="28fee-101">If `dotnet ef` has not been installed, install it as a global tool:</span></span>
