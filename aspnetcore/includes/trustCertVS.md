<span data-ttu-id="8da1e-101">Visual Studio는 다음 대화 상자를 표시합니다.</span><span class="sxs-lookup"><span data-stu-id="8da1e-101">Visual Studio displays the following dialog:</span></span>
