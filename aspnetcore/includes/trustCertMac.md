<span data-ttu-id="92003-101">Mac용 Visual Studio에 다음 팝업이 표시됩니다.</span><span class="sxs-lookup"><span data-stu-id="92003-101">Visual Studio for Mac displays the following popup:</span></span>
