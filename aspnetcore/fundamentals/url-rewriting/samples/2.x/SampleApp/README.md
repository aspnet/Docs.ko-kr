# <a name="aspnet-core-url-rewriting-sample"></a><span data-ttu-id="995d6-101">ASP.NET Core URL 다시 작성 샘플</span><span class="sxs-lookup"><span data-stu-id="995d6-101">ASP.NET Core URL Rewriting Sample</span></span>
