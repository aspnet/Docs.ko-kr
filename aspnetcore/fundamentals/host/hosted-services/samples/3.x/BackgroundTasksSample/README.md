# <a name="aspnet-core-background-tasks-sample"></a><span data-ttu-id="aa257-101">ASP.NET Core 백그라운드 작업 샘플</span><span class="sxs-lookup"><span data-stu-id="aa257-101">ASP.NET Core Background Tasks Sample</span></span>
