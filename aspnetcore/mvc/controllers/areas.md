...
<span data-ttu-id="65edf-121">페이지를 사용 하 Razor 는 경우이 문서의 [ Razor 페이지를 포함](#areas-with-razor-pages) 하는 영역을 참조 하세요.</span><span class="sxs-lookup"><span data-stu-id="65edf-121">If you're using Razor Pages, see [Areas with Razor Pages](#areas-with-razor-pages) in this document.</span></span>
...
### <a name="_viewimportscshtml"></a><span data-ttu-id="65edf-179">_ViewImports.cshtml</span><span class="sxs-lookup"><span data-stu-id="65edf-179">_ViewImports.cshtml</span></span>
 ...
 <span data-ttu-id="65edf-180">*/Views/_ViewImports* (MVC의 경우) 및/페이지에 대 한 */_ViewImports/* Razor 는 영역에서 뷰로 가져오지 않습니다.</span><span class="sxs-lookup"><span data-stu-id="65edf-180">*/Views/_ViewImports.cshtml* , for MVC, and */Pages/_ViewImports.cshtml* for Razor Pages, is not imported to views in areas.</span></span> <span data-ttu-id="65edf-181">다음 방법 중 하나를 사용 하 여 모든 보기에 대 한 보기 가져오기를 제공 합니다.</span><span class="sxs-lookup"><span data-stu-id="65edf-181">Use one of the following approaches to provide view imports to all views:</span></span>
...
## <a name="areas-with-no-locrazor-pages"></a><span data-ttu-id="65edf-189">페이지가 있는 영역 Razor</span><span class="sxs-lookup"><span data-stu-id="65edf-189">Areas with Razor Pages</span></span>

<span data-ttu-id="65edf-190">페이지를 포함 하는 영역 Razor `Areas/<area name>/Pages` 에는 앱의 루트 폴더가 필요 합니다.</span><span class="sxs-lookup"><span data-stu-id="65edf-190">Areas with Razor Pages require an `Areas/<area name>/Pages` folder in the root of the app.</span></span> <span data-ttu-id="65edf-191">[예제 앱](https://github.com/dotnet/AspNetCore.Docs/tree/master/aspnetcore/mvc/controllers/areas/31samples)에서는 다음 폴더 구조가 사용됩니다.</span><span class="sxs-lookup"><span data-stu-id="65edf-191">The following folder structure is used with the [sample app](https://github.com/dotnet/AspNetCore.Docs/tree/master/aspnetcore/mvc/controllers/areas/31samples):</span></span>
...
### <a name="link-generation-with-no-locrazor-pages-and-areas"></a><span data-ttu-id="65edf-204">페이지 및 영역을 사용한 링크 생성 Razor</span><span class="sxs-lookup"><span data-stu-id="65edf-204">Link generation with Razor Pages and areas</span></span>
...
<span data-ttu-id="65edf-219">각 영역 *페이지* 폴더에 *_ViewImports* 파일을 추가 하 여 네임 스페이스 및 태그 도우미를 폴더의 각 페이지로 가져올 수 있습니다 Razor .</span><span class="sxs-lookup"><span data-stu-id="65edf-219">A *_ViewImports.cshtml* file can be added to each area *Pages* folder to import the namespace and Tag Helpers to each Razor Page in the folder.</span></span>

<span data-ttu-id="65edf-220">*_ViewImports.cshtml* 파일이 없는 샘플 코드의 *Services* 영역을 살펴보겠습니다.</span><span class="sxs-lookup"><span data-stu-id="65edf-220">Consider the *Services* area of the sample code, which doesn't contain a *_ViewImports.cshtml* file.</span></span> <span data-ttu-id="65edf-221">다음 태그는 */Services/Manage/About* 페이지를 보여 줍니다 Razor .</span><span class="sxs-lookup"><span data-stu-id="65edf-221">The following markup shows the */Services/Manage/About* Razor Page:</span></span>
...
<span data-ttu-id="65edf-226">다음 태그는 */Products/About* 페이지를 보여 줍니다 Razor .</span><span class="sxs-lookup"><span data-stu-id="65edf-226">The following markup shows the */Products/About* Razor Page:</span></span>
...
### <a name="shared-layout-for-no-locrazor-pages-areas"></a><span data-ttu-id="65edf-229">페이지 영역에 대 한 공유 레이아웃 Razor</span><span class="sxs-lookup"><span data-stu-id="65edf-229">Shared layout for Razor Pages Areas</span></span>
...
<span data-ttu-id="65edf-247">페이지를 사용 하 Razor 는 경우이 문서의 [ Razor 페이지를 포함](#areas-with-razor-pages) 하는 영역을 참조 하세요.</span><span class="sxs-lookup"><span data-stu-id="65edf-247">If you're using Razor Pages, see [Areas with Razor Pages](#areas-with-razor-pages) in this document.</span></span>
...
## <a name="areas-with-no-locrazor-pages"></a><span data-ttu-id="65edf-306">페이지가 있는 영역 Razor</span><span class="sxs-lookup"><span data-stu-id="65edf-306">Areas with Razor Pages</span></span>

<span data-ttu-id="65edf-307">페이지를 포함 하는 영역 Razor `Areas/<area name>/Pages` 에는 앱의 루트 폴더가 필요 합니다.</span><span class="sxs-lookup"><span data-stu-id="65edf-307">Areas with Razor Pages require an `Areas/<area name>/Pages` folder in the root of the app.</span></span> <span data-ttu-id="65edf-308">[예제 앱](https://github.com/dotnet/AspNetCore.Docs/tree/master/aspnetcore/mvc/controllers/areas/samples)에서는 다음 폴더 구조가 사용됩니다.</span><span class="sxs-lookup"><span data-stu-id="65edf-308">The following folder structure is used with the [sample app](https://github.com/dotnet/AspNetCore.Docs/tree/master/aspnetcore/mvc/controllers/areas/samples):</span></span>
...
### <a name="link-generation-with-no-locrazor-pages-and-areas"></a><span data-ttu-id="65edf-321">페이지 및 영역을 사용한 링크 생성 Razor</span><span class="sxs-lookup"><span data-stu-id="65edf-321">Link generation with Razor Pages and areas</span></span>
...
<span data-ttu-id="65edf-337">각 영역 *페이지* 폴더에 *_ViewImports* 파일을 추가 하 여 네임 스페이스 및 태그 도우미를 폴더의 각 페이지로 가져올 수 있습니다 Razor .</span><span class="sxs-lookup"><span data-stu-id="65edf-337">A *_ViewImports.cshtml* file can be added to each area *Pages* folder to import the namespace and Tag Helpers to each Razor Page in the folder.</span></span>

<span data-ttu-id="65edf-338">*_ViewImports.cshtml* 파일이 없는 샘플 코드의 *Services* 영역을 살펴보겠습니다.</span><span class="sxs-lookup"><span data-stu-id="65edf-338">Consider the *Services* area of the sample code, which doesn't contain a *_ViewImports.cshtml* file.</span></span> <span data-ttu-id="65edf-339">다음 태그는 */Services/Manage/About* 페이지를 보여 줍니다 Razor .</span><span class="sxs-lookup"><span data-stu-id="65edf-339">The following markup shows the */Services/Manage/About* Razor Page:</span></span>
...
<span data-ttu-id="65edf-344">다음 태그는 */Products/About* 페이지를 보여 줍니다 Razor .</span><span class="sxs-lookup"><span data-stu-id="65edf-344">The following markup shows the */Products/About* Razor Page:</span></span>
...
### <a name="shared-layout-for-no-locrazor-pages-areas"></a><span data-ttu-id="65edf-347">페이지 영역에 대 한 공유 레이아웃 Razor</span><span class="sxs-lookup"><span data-stu-id="65edf-347">Shared layout for Razor Pages Areas</span></span>
